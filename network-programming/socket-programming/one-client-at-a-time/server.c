...
int main()
{
    ...
    while (1)
    {
        ...
        // sleep(30);
        // if you sleep here after each client connection,
        // the server will wait for X seconds and then only
        // read the client's message and then respond to it
        // and then only accept next client through `accept()`.
        // Till then, if other clients are trying to connect to
        // the server, they will just be still and blocking -
        // assuming they don't have a timeout
